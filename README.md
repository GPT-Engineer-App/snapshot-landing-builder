...
**Project**: snapshot-landing-builder 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Make me a landing page for a website based on this screenshot 
...
```sh
git clone https://github.com/GPT-Engineer-App/snapshot-landing-builder.git
cd snapshot-landing-builder
npm i
